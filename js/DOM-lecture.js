...
// Let's grab out LIs with the class of "hat-sold"
...
// WOOPS - we got another call from the people upstairs. Can we change "Our Top Sellers" to be something that makes mire sense - like "Will update soon!"

var bestSellerHeader = document.getElementById("best-seller");

console.log(bestSellerHeader);

bestSellerHeader.innerText = "Will update soon!"; // can't use tags here - will end up being printed on teh screen
